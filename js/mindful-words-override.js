 ...
 * do i need that for mindful words?
 */
(function ($) {
"use strict";
...
Backdrop.behaviors.color = {
  ...
  attach: function (context) {
    ...
    const previewMarkup = '<div class="color-preview"><iframe id="preview" src="' + Backdrop.settings.mindful_words.previewUrl + '"></iframe></div>';
